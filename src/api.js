...
export const getMediaVideos = (mediaType, id) => fetchMedia(`/${mediaType}/${id}/videos`)
export const searchMedia = (mediaType, searchTerm) => fetchMedia(`/search/${mediaType}?query=${searchTerm}`)